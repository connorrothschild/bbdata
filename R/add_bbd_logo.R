...
#'
#' @example \dontrun{
#' add_bbd_logo(plot, position = "top right", scale = 1.5)
#' }
#'
...
add_bbd_logo <- function(plot, position = "top right", scale = 1) {
  ...
  logo_raw <- magick::image_read('https://raw.githubusercontent.com/connorrothschild/bbdata/master/figures/logo.png')
